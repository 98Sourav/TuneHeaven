...
export type LatestBlogArticlesQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LatestBlogArticlesQuery = {
  blogs: {
    nodes: Array<
...
export type CategoryCollectionsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type CategoryCollectionsQuery = {
  collections: {
    nodes: Array<
      Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
        image?: StorefrontAPI.Maybe<
...
export type TopBrandsMetaobjectsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type TopBrandsMetaobjectsQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query HeroSlides($first: Int = 5) {\n    metaobjects(type: "hero_slide", first: $first) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          type\n          reference {\n            ... on MediaImage {\n              image {\n                url\n                altText\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
  ...
  '#graphql\n  query LatestBlogArticles($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    blogs(first: 1) {\n      nodes {\n        id\n        handle\n        title\n        articles(first: 3, sortKey: PUBLISHED_AT, reverse: true) {\n          nodes {\n            id\n            title\n            handle\n            excerpt\n            publishedAt\n            image {\n              id\n              altText\n              url\n            }\n            author: authorV2 {\n              name\n            }\n            blog {\n              handle\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: LatestBlogArticlesQuery;
    variables: LatestBlogArticlesQueryVariables;
  };
  ...
  '#graphql\n  query CategoryCollections {\n    collections(first: 5, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        id\n        title\n        handle\n        image {\n          url\n          altText\n        }\n      }\n    }\n  }\n': {
    return: CategoryCollectionsQuery;
    variables: CategoryCollectionsQueryVariables;
  };
  '#graphql\n  query TopBrandsMetaobjects {\n    metaobjects(type: "brands", first: 12) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              image {\n                url\n                altText\n              }\n            }\n            ... on Collection {\n              id\n              title\n              handle\n              image {\n                url\n                altText\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: TopBrandsMetaobjectsQuery;
    variables: TopBrandsMetaobjectsQueryVariables;
  };
